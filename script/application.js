...
function main(playerId, worldData) {
  ...
  TILES_IN_BIG_TILE = worldData.TILES_IN_BIG_TILE;
  TILE_SIZE = worldData.TILE_SIZE;
  MAP_SIZE = worldData.MAP_SIZE;
  DEV_MODE = worldData.DEV_MODE;
  PLAYER_ID = playerId;
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  socket = io();
  socket.on("worldSettings", function(worldData) {
    if(!WORLD_SETUP) {
      WORLD_SETUP = true;
      main(playerId, worldData);
    }
  });
